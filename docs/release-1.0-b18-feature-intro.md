...
> 合并与 tag 状态：2026-07-07 23:35 CST 完成 `main` 合并，并创建 `v1.0-b18` tag。
...
- TestFlight `1.0 (18)` 已安装并完成回归，本次发布合并到 `main` 后创建 `v1.0-b18` tag。
...
- `codex/fix-exercise-library-keyboard` 已合并回 `main`，并创建 `v1.0-b18` tag。
