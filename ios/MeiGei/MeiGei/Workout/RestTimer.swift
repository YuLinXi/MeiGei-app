...
extension Notification.Name {
    ...
    static let meigeiRestEndedExternally = Notification.Name("meigei.rest.endedExternally")
}
...
final class RestTimerController {
    ...
    private func observeExternalEnd() {
        CFNotificationCenterAddObserver(
            ...
            nil,
            { _, _, _, _, _ in
                Task { @MainActor in NotificationCenter.default.post(name: .meigeiRestEndedExternally, object: nil) }
            },
            RestSignal.endRestName as CFString,
            nil,
            .deliverImmediately)
        NotificationCenter.default.addObserver(
            forName: .meigeiRestEndedExternally, object: nil, queue: .main) { [weak self] _ in
