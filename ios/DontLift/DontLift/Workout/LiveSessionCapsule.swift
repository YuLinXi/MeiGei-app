...
///
/// 有活跃会话时浮于首页内容之上：白底胶囊 + 朱砂红脉冲点 + 会话名称，
...
struct LiveSessionCapsule: View {
    ...
    /// 实测胶囊尺寸（随名称长度变化，用于边界夹取与吸附）。
    @State private var size: CGSize = .init(width: 120, height: 38)
