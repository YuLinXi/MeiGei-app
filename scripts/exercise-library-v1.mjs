...
const manualCodes = new Map(Object.entries({
  ...
  "哑铃臂屈伸": "TRICEP_KICKBACK",
  "单臂哑铃臂屈伸": "SINGLE_ARM_DB_TRICEP_EXT",
  ...
  "肩部动态热身": "SHOULDER_WARMUP",
  "招财猫": "SHOULDER_90_90_EXTERNAL_ROTATION",
  "弹力带肩外旋": "BAND_SHOULDER_EXTERNAL_ROTATION",
...
const manualAliases = [
  ...
  { targetName: "哑铃臂屈伸", legacyNames: ["哑铃臂屈伸后踢", "哑铃三头后踢"] },
  { targetName: "招财猫", legacyNames: ["招财猫式肩外旋", "肩背热身招财猫"] },
  { targetName: "弹力带肩外旋", legacyNames: ["肩关节外旋训练", "肩外旋训练", "弹力带肩关节外旋"] },
